...
async def get_workflow_templates(category: str):
    ...
    templates = {"ci_cd": {"standard_pipeline": {"name": "Standard CI/CD Pipeline",
                 ...
                 "deployment": {"blue_green": {"name": "Blue-Green Deployment",
                                               "description": "Blue-green deployment workflow",
                                               "category": "deployment",
                                               "steps": [{"name": "Deploy Blue",
                                                         ...
                                                         {"name": "Health Check",
                                                          ...
                                                          "action": "api_call",
                                                          "parameters": {"url": "/health",
                                                                         "timeout": 30},
                                                          },
                                                         {"name": "Switch Traffic",
                                                          "description": "Switch traffic to blue",
                                                          "action": "script",
                                                          "parameters": {"script": 'kubectl patch svc app -p \'{"spec":{"selector":{"version":"blue"}}}\''},
                                                          },
                                                         ],
                                               "triggers": ["manual"],
                                               "tags": ["deployment",
                 ...
                 "security": {"security_scan": {"name": "Security Scan Workflow",
                                                "description": "Comprehensive security scanning workflow",
                                                "category": "security",
                                                "steps": [{"name": "Vulnerability Scan",
