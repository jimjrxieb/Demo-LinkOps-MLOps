...
class OrbScorer:
    ...
    def _calculate_orb_score(self, task_lower: str, orb: Dict[str, Any]) -> float:
        ...
        keyword_matches = sum(1 for keyword in keywords if keyword.lower() in task_lower)
    ...
    def _generate_recommendation(self, best_match: Optional[Dict[str, Any]], task: str) -> Dict[str, Any]:
    ...
    def get_library_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "average_keywords_per_orb": total_keywords / len(self.orb_library) if self.orb_library else 0,
