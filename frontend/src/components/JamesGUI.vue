    ...
    <div v-if="currentResult" class="results-section">
      ...
      <div v-if="currentResult.generatedOrb" class="result-card">
        ...
        <div class="generated-orb">
          ...
          <div class="orb-meta">
            <span class="meta-tag">Generated by: {{ currentResult.generatedOrb.demo_warning ? 'Demo Mode' : 'Whis Logic' }}</span>
            <span class="meta-tag">AI Model: {{ currentResult.generatedOrb.demo_warning ? 'Simulated' : 'Grok API' }}</span>
          </div>
        </div>
      ...
      <div v-if="showRejectionMessage" class="rejection-popup-overlay">
        <div class="rejection-popup">
          <div class="popup-header">
            ...
            <button @click="showRejectionMessage = false" class="popup-close">×</button>
          </div>
