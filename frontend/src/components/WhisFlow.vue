...
.step {
  @apply flex items-center gap-4 p-3 rounded border border-gray-600;
}
...
.step-number {
  @apply w-8 h-8 rounded-full bg-gray-600 flex items-center justify-center text-sm font-bold;
}
