        ...
        <div class="flex justify-between items-center py-6">
          <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
              Train AI models to predict property management outcomes. No coding
              required.
            </p>
          </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
        ...
        <p class="text-blue-800 mb-4">
          Upload your property management data and train AI models to predict
          outcomes like eviction risk, renewal probability, and maintenance
          needs.
        </p>
        <div
      ...
      >
        ...
        <div class="mb-6">
          ...
          <p class="mt-2 text-xs text-gray-500">
            Upload a CSV file with your property management data. Include
            columns like rent_amount, late_payments, tenant_tenure, etc.
          </p>
        </div>
          ...
          <div class="bg-gray-50 rounded-lg p-4">
            <div class="flex justify-between items-center mb-3">
              <span class="text-sm font-medium text-gray-700">
                ...
                {{ dataPreview.rowCount }} rows
              </span>
              <span class="text-xs text-gray-500"> First 5 rows shown </span>
            </div>
        ...
        >
          ...
          <div class="mb-4">
            ...
            <p class="mt-1 text-xs text-gray-500">
              Choose the column you want the model to predict (e.g.,
              eviction_risk, renewal_probability)
            </p>
          </div>
          ...
          <div class="mb-4">
            ...
            <p class="mt-1 text-xs text-gray-500">
              ...
              Regression for numbers (e.g., rent amount)
            </p>
          </div>
        ...
        <!-- Step 4: Train Model -->
        <div
          v-if="modelConfig.targetColumn && modelConfig.modelName"
          class="mb-6"
        >
          <button
            :disabled="training"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="border border-gray-200 rounded-lg p-4">
            ...
            <p class="text-sm text-gray-600 mb-3">
              Predict which tenants are at risk of eviction based on payment
          ...
          <div class="border border-gray-200 rounded-lg p-4">
            ...
            <p class="text-sm text-gray-600 mb-3">
              Predict which tenants are likely to renew their leases based on
              satisfaction and history.
            </p>
            <div class="text-xs text-gray-500">
          ...
          <div class="border border-gray-200 rounded-lg p-4">
            ...
            <p class="text-sm text-gray-600 mb-3">
              Predict which units are likely to need maintenance based on age
              and usage patterns.
            </p>
            <div class="text-xs text-gray-500">
