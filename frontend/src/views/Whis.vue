    ...
    <section class='config-section'>;
      ...
      <div class='config-grid'>;
        <div class='config-card'>;
          ...
          <label>;
            <input type="checkbox" v-model="config.removeDuplicates" />;
            Remove duplicates;
          </label>;
        </div>;
        ...
        <div class='config-card'>;
          ...
          <label>;
            <input type="checkbox" v-model="config.validate" />;
            Validate output;
          </label>;
        </div>;
      ...
      switch (stepIndex) {
        case 0: // Data Input;
          return {
            ...
            metrics: 'Input validation passed';
          }
        ...
        case 1: // Sanitization;
          return {
            ...
            metrics: 'Removed 10 invalid characters';
          }
        ...
        case 2: // Smithing;
          return {
            ...
            metrics: 'Transformed to JSON format';
          }
        ...
        case 3: // Enhancement;
          return {
            ...
            metrics: 'Added 5 ML-derived features';
          }
        ...
        case 4: // Output;
          return {
            ...
            metrics: 'Pipeline completed successfully';
          }
