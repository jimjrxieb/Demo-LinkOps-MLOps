    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        for key, value in record.__dict__.items():
            if key not in ['name', 'msg', 'args', 'levelname', 'levelno', 'pathname', 
                          ...
                          'exc_text', 'stack_info', 'service_name', 'service_version', 
                          'environment']:
                log_entry[key] = value
...
class LinkOpsLogger(logging.Logger):
    ...
    def __init__(self, name: str, service_name: str = None, service_version: str = None, environment: str = None):
        super().__init__(name)
...
def log_function_call(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        try:
            ...
            logger.debug(f"Exiting {func.__name__} successfully", extra={
                'function': func.__name__,
...
def log_service_stop(service_name: str):
    ...
    logger = get_logger(service_name)
    logger.info("Service stopping", extra={
        'event': 'service_stop',
        'service_name': service_name
    })
...
def log_database_operation(
    ...
    logger.log(log_level, "Database operation", extra={
...
def log_external_api_call(
    ...
    logger.log(log_level, "External API call", extra={
