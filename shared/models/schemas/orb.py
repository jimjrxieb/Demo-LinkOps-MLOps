...
class Orb(BaseEntity):
    ...
    title: str = Field(
        min_length=1,
        max_length=200,
        description="Title of the Orb"
    )
    content: str = Field(
        min_length=1,
        description="Main content of the Orb"
    )
    category: OrbCategory = Field(
        description="Category of the Orb"
    )
    status: OrbStatus = Field(
        default=OrbStatus.DRAFT,
        description="Status of the Orb"
    )
    ...
    description: Optional[str] = Field(
        default=None,
        max_length=500,
        description="Brief description of the Orb"
    )
    summary: Optional[str] = Field(
        default=None,
        max_length=1000,
        description="Detailed summary of the Orb"
    )
    
    # Content metadata
    content_type: str = Field(
        default="markdown",
        description="Type of content (markdown, yaml, json, etc.)"
    )
    ...
    rune_ids: List[str] = Field(
        default_factory=list,
        description="IDs of related Runes"
    )
    ...
    usage_count: int = Field(
        default=0,
        ge=0,
        description="Number of times this Orb has been used"
    )
    ...
    quality_score: float = Field(
        ...
        ge=0.0,
        le=1.0,
        description="Quality score of the Orb (0.0 to 1.0)"
    )
    validated: bool = Field(
        default=False,
        description="Whether the Orb has been validated"
    )
    validated_by: Optional[str] = Field(
        default=None,
        description="User or service that validated the Orb"
    )
    validated_at: Optional[datetime] = Field(
        default=None,
        description="Timestamp when the Orb was validated"
    )
    
    # Source information
    source_url: Optional[str] = Field(
        default=None,
        description="URL where the Orb content originated"
    )
    source_type: Optional[str] = Field(
        default=None,
        description="Type of source (documentation, blog, etc.)"
    )
    
    # Metadata
    metadata: Dict[str, Any] = Field(
        default_factory=dict,
        description="Additional metadata for the Orb"
    )
...
class OrbUpdate(BaseEntity):
    ...
    status: Optional[OrbStatus] = Field(
        default=None,
        description="Status of the Orb"
    )
    description: Optional[str] = Field(
