        ...
        if 'import subprocess' in content:
            ...
            for i, line in enumerate(lines):
                if line.strip() == 'import subprocess':
                    lines[i] = '# Security: subprocess is used for system commands - ensure inputs are sanitized\nimport subprocess'
                    changes_made += 1
                    break
...
def main():
    ...
    if fixed_files > 0:
        ...
        print("⚠️  Please review the changes and ensure they meet your security requirements.")
    else:
